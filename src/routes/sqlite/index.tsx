          ...
          {!isLoading && connections.length > 0 && (
            <div className="grid gap-4">
              {connections.map((connection) => (
                <button
                  className="group rounded-lg border border-zinc-400 bg-zinc-100 p-5 text-left transition-all hover:border-green-500/50 hover:bg-zinc-200 hover:shadow-md hover:shadow-zinc-300 dark:border-zinc-700/50 dark:bg-zinc-800/50 dark:hover:bg-zinc-800 dark:hover:shadow-green-500/10"
                  key={connection.id}
